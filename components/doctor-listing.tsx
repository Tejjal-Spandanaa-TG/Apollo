...
export default function DoctorListing() {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-800 mb-2">Find the Best Doctors Near You</h1>
        <p className="text-gray-600">Browse through our list of qualified doctors and book an appointment today.</p>
      </div>
